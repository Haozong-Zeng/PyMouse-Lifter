...
## Processing the fine-tuned models
Use LoadFine-tunedModel.ipynb
## Replicate the delay & FPS estimation with flashing LEDs
Use run_PyMouseLifter_online_classification_LED.py with devices like LabJack U3-LV, 2 LED with appropriate switching circuit, and a high-speed camera.

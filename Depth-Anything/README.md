...
## Pseudo labels from a pretrained Depth Anything model
Download the pretrained models from https://huggingface.co/spaces/LiheYoung/Depth-Anything/tree/main/checkpoints_metric_depth <br />Use LoadFine-tunedModel.ipynb to remove the metric bin module as the pretrained model has not been fine-tuned on a mouse dataset.
